...
"armv8l-linux-thread-multi-4.14.78-1-vanilla" or
	die "Errno architecture (armv8l-linux-thread-multi-4.14.78-1-vanilla) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
