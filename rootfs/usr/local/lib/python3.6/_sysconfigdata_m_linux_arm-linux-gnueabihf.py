...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'arm-unknown-linux-musleabihf',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--build=arm-linux-musleabihf' "
                "'--enable-loadable-sqlite-extensions' "
                "'--enable-optimizations' '--enable-shared' "
                "'--with-system-expat' '--with-system-ffi' "
                "'--without-ensurepip' 'build_alias=arm-linux-musleabihf'",
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'arm-unknown-linux-musleabihf',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall   -DTHREAD_STACK_SIZE=0x100000 -std=c99 -Wextra '
